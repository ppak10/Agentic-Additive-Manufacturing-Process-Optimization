...
const SECTIONS: { title: string; defaultOpen?: boolean; fields: FieldSpec[] }[] = [
  {
    ...
    fields: [
      ...
      { key: "recoaterShakePercent", label: "Recoater shake", unit: "%", kind: "num", min: 0, max: 100, step: 1 },
      { key: "recoaterMaxDistance", label: "Recoater max distance", unit: "mm", kind: "num", min: 0, max: 1000, step: 1 },
      { key: "addPowderDepth", label: "Add powder depth", unit: "µm", kind: "num", min: 0, max: 50000, step: 10 },
      { key: "powderVolumePercent", label: "Powder volume", unit: "%", kind: "num", min: 0, max: 500, step: 1 },
      { key: "zMove", label: "Z move", kind: "num", min: 0, max: 5000, step: 10 },
    ],
  },
  {
    title: "Heating",
    fields: [
      ...
      { key: "heatingTargetPrintBed2", label: "Target: print bed 2", unit: "°C", kind: "num", min: 0, max: 200, step: 0.5 },
      { key: "heatingTargetPrintBed2Thickness1", label: "Print bed 2 thickness 1", unit: "µm", kind: "num", min: 0, max: 50000, step: 500 },
      { key: "heatingTargetPrintBed2Thickness2", label: "Print bed 2 thickness 2", unit: "µm", kind: "num", min: 0, max: 50000, step: 500 },
      { key: "heatingTargetAnalyse", label: "Target: analyse", unit: "°C", kind: "num", min: 0, max: 200, step: 0.5 },
      ...
      { key: "heatingLayerStartTemperature", label: "Layer start temp", unit: "°C", kind: "num", min: 0, max: 200, step: 0.5 },
      { key: "heatingLayerEndTemperature", label: "Layer end temp", unit: "°C", kind: "num", min: 0, max: 200, step: 0.5 },
      { key: "heatingLayerPeriod", label: "Layer period", unit: "s", kind: "delay" },
      { key: "heatingMinimumTime", label: "Minimum time", unit: "s", kind: "delay" },
      { key: "halogenMaxPercent", label: "Halogen max", unit: "%", kind: "num", min: 0, max: 100, step: 1 },
      { key: "surfaceTarget", label: "Surface target", unit: "°C", kind: "num", min: 0, max: 200, step: 0.5 },
      { key: "surfaceTarget2", label: "Surface target 2", unit: "°C", kind: "num", min: 0, max: 200, step: 0.5 },
      { key: "surfaceTarget2Time", label: "Surface target 2 time", unit: "s", kind: "delay" },
      { key: "surfaceHeatingRate", label: "Surface heating rate", kind: "num", min: 0, max: 100, step: 0.1 },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: "layerExtendDelay", label: "Layer extend delay", unit: "s", kind: "delay" },
      ...
      { key: "bedPreparationTemperatureIncrease", label: "Bed prep temp increase", kind: "bool" },
      { key: "bedPreparationTemperatureIncreaseFromPercent", label: "Bed prep increase from", unit: "%", kind: "num", min: 0, max: 100, step: 1 },
      { key: "bedPreparationTemperatureIncreaseToPercent", label: "Bed prep increase to", unit: "%", kind: "num", min: 0, max: 100, step: 1 },
      { key: "bedPreparationFirstExtraThickLayerCount", label: "Extra thick layers", kind: "num", min: 0, max: 100, step: 1 },
      { key: "bedPreparationFirstExtraThicknessMultiplier", label: "Extra thickness ×", kind: "num", min: 0, max: 10, step: 0.1 },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "totalIncreasedEnergyDensityPercent", label: "Total increased energy", unit: "%", kind: "num", min: 0, max: 500, step: 1 },
      ...
      { key: "outlinePowerIncrease", label: "Outline power increase", kind: "num", min: 0, max: 100, step: 0.5 },
      { key: "outlinePowerPrecision", label: "Outline power precision", kind: "num", min: 0, max: 100, step: 0.5 },
      { key: "fillOutlineSkipCount", label: "Fill outline skip", kind: "num", min: 0, max: 20, step: 1 },
      { key: "hotspotOverlapPercent", label: "Hotspot overlap", unit: "%", kind: "num", min: 0, max: 100, step: 1 },
      { key: "sinteredVolumeFactor", label: "Sintered volume factor", kind: "num", min: 0, max: 10, step: 0.1 },
      { key: "customSinteredVolumePercent", label: "Custom sintered volume", unit: "%", kind: "num", min: 0, max: 500, step: 1 },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "coolingTimePercent", label: "Cooling time", unit: "%", kind: "num", min: 0, max: 100, step: 1 },
      { key: "coolingMinimumTime", label: "Minimum time", unit: "s", kind: "delay" },
      { key: "coolingHeatHold", label: "Heat hold", kind: "bool" },
    ],
  },
  {
    title: "Auto-tuning",
    defaultOpen: false,
    fields: [
      { key: "autoTuningEnabled", label: "Auto-tuning enabled", kind: "bool" },
      { key: "isAutoHeatingEnabled", label: "Auto heating", kind: "bool" },
      { key: "isAutoCoolingEnabled", label: "Auto cooling", kind: "bool" },
      { key: "useSoftHeater", label: "Use soft heater", kind: "bool" },
      { key: "autoTuningExpectedDetectionTemperature", label: "Expected detection temp", unit: "°C", kind: "num", min: 0, max: 200, step: 0.5 },
      { key: "autoTuningMaxTemperature", label: "Max temp", unit: "°C", kind: "num", min: 0, max: 200, step: 0.5 },
      { key: "autoTuningTemperatureOffset", label: "Temp offset", unit: "°C", kind: "num", min: -50, max: 50, step: 0.5 },
      { key: "autoTuningTemperatureStep", label: "Temp step", unit: "°C", kind: "num", min: 0, max: 50, step: 0.5 },
      { key: "autoTuningThresholdPercent", label: "Threshold", unit: "%", kind: "num", min: 0, max: 100, step: 0.5 },
      { key: "autoTuningLayerThicknessMultiplier", label: "Layer thickness ×", kind: "num", min: 0, max: 10, step: 0.1 },
    ],
  },
];
